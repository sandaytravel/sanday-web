            ...
            <div class="middle-box text-center animated fadeInDown">
                ...
                <div>
                    <div>
                        ...
                        <p class="app-stores color_white">Create your password.</p>
                    </div>
                    {{ Form::open(['route' => ['merchant-create-password',\Crypt::encryptString($user->id)], 'method' => 'POST','class' => 'm-t','role' => 'form','id' => 'resetpassword-form']) }}
                    {{ csrf_field() }}
                    ...
                    <button type="submit" class="btn btn-primary block full-width m-b">Create Now</button>
