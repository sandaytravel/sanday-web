        ...
        <div class="loginscreen">
            <div class="middle-box text-center  animated fadeInDown">
                ...
                <div>
                    ...
                    {{ Form::open(['route' => 'postForgotPassword', 'method' => 'POST','class' => 'm-t','role' => 'form','id' => 'forgotpassword-form']) }}
                    {{ csrf_field() }}
                    <div class="form-group">
                        {{ Form::text('email', '', ['class' => 'form-control','id'=>'User','placeholder' => 'Enter your email address']) }} 
                    </div>
                    ...
                    <div class="form-group">
                        <div class="pull-right">
                            <a href="{{route('loginform')}}" class="forgot-pass-link color_white hvr_clrp">Login?</a>
                        </div>
                    </div>
